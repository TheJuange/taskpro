    ...
    <main class="w-full flex flex-col items-center mt-20">
        ...
        <section class="w-3/6 mt-10 flex gap-4 items-center">
            <picture class="w-2/12 ">
                <img class="rounded-full object-cover aspect-square" src="{{asset("images/fondo.png")}}" alt="">
            </picture>
            <section class="w-9/12 flex flex-col gap-2">
                <p class="text-neutral-300 text-2xl font-semibold capitalize">mi primera tarea</p>
                <p class="text-sm text-neutral-700 font-semibold">12/08/2025</p>
                <p class="bg-red-500 rounded-md py-1 px-2 text-neutral-300 w-max">high</p>
            </section>
        ...
        <section class="w-3/6 mt-10 flex gap-4 items-center">
            ...
            <section class="w-9/12 flex flex-col gap-2">
                <p class="text-neutral-300 text-2xl font-semibold capitalize">realizar taskpro</p>
                <p class="text-sm text-neutral-700 font-semibold">12/02/2025</p>
                <p class="bg-green-800 rounded-md py-1 px-2 text-neutral-300 w-max">lower</p>
            </section>
            <section class="w-1/12 flex gap-4">
                <a class="text-neutral-300 font-semibold" href=""><svg xmlns="http://www.w3.org/2000/svg" height="20"
                        width="20" viewBox="0 0 512 512">
